        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.reservation.index') }}"
                   class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Back to Reservation page</a>
            </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                >
                                    @foreach($tables as $table)
                                        <option value="{{ $table->id }}" @selected(old('table_id', $reservation->table_id) == $table->id)>{{ $table->name }} ( for {{ $table->guest_number }} guests ) </option>
                                    @endforeach
                                </select>
                                @error('table_id')
                                <div class="text-sm text-red-400">{{ $message }}</div>
