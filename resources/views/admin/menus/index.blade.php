                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    @foreach($menus as $menu)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ Storage::url($menu->image) }}" class="w-16 h-16 rounded" alt="image">
                            </td>
                            <td class="px-6 py-4 text-right flex space-x-2">
                                ...
                                <form
                                    class="px-4 px-2 font-medium text-white dark:text-white bg-red-500 hover:bg-red-700 rounded-lg "
                                    method="POST"
